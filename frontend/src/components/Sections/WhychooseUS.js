      ...
      <section id="why-us" className="why-us">
        <div className="container-fluid" data-aos="fade-up">
          <header className="section-header text-center my-5 mb-5">
            <h3>Why choose us?</h3>
            <p>
              GadgetZon has advanced skills of Aircond Services and everything
            ...
            <div className="col-lg-6 text-left">
              <div className="why-us-content">
                ...
                >
                  ...
                  <p>
                    Our aircond services are much faster because GadgetZon ready
                ...
                <div
                  ...
                  data-aos-delay="100"
                >
                  <i className="fa fa-pkr" style={{ color: 'gold' }}></i>
